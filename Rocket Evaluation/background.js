...
var crdBEMTask1 = 
{
	...
	"aspects": [
		...
		},
		{
			...
			"grades": [
				{"name":"Approaching Competence","text":["The Python script that extracts web links from the HTML code of the Current Estimates web site executes without readily observable warnings or errors. The script extracts a limited subset of web links to other HTML pages from the code of the Current Estimates web page."]},
		...
		},
		{
			...
			"grades": [
				...
				{"name":"Passing","text":["The submission provides a functioning Python scraper that extracts [HOW MANY] unique web links to HTML pages from the code of the Current Estimates web page and presents them in a CSV file in an absolute format and R code that constructs a fitting linear regression model of the population dynamics of the State of [WHICH STATE] used to predict its population size for the year [WHICH YEAR].  All sections of the work, including R: Statistical Description, are complete and meet standards."]}
			]
		}
	]
};
	...
	"aspects": [
		{
			...
			"grades": [
				{"name":"Competent","text":["The submission presents adequate analyses of the attributes of the three audiences to whom the new SVC process will be delivered."]}
			]
		},
		{
			"name":"B. Modification of Presentation", 
			"grades": [
				{"name":"Competent","text":["A clear summary of reasonable proposed changes to the presentation for Audience 1 to meet the needs of Audience 2 is provided."]}
			]
		},
		{
			"name":"D. Step-By-Step Instructions", 
			"grades": [
				{"name":"Competent","text":["Adequately detailed procedural instructions that describe the process of [SUMMARIZE PROCESS] for the members of Audience 3 are provided. [HOW MANY] clear multimedia elements effectively support the explanations of the process steps."]}
			]
		},
		{
			"name":"Overall Comment",
			"grades": [
				{"name":"Passing","text":["The submission presents sound analyses of the three audiences to whom the new SVC process will be delivered, the changes to the presentation for Audience 1 to meet the needs of Audience 2, and the steps needed to [SUMMARIZE PROCESS] for Audience 3. All sections of the work, including Justification for Modifying, are complete and meet standards."]}
			]
		}
	]
};
...
var crdIYPTask1 = 
{
	...
	"aspects": [
		...
		},
		{
			...
			"grades": [
				{"name":"Competent","text":["The submission appropriately includes scraped data for Criteria 1 in the \"<FILENAME>\" file."]}
			]
		},
		{
			"name":"B. Scraped Data: Criteria 2", 
			"grades": [
				{"name":"Competent","text":["The submission appropriately includes scraped data for Criteria 2 in the \"<FILENAME>\" file."]}
			]
		},
		{
			"name":"C. Cleaned Data: Criteria 1", 
			"grades": [
				{"name":"Competent","text":["An appropriately configured dataset that presents the values of the Safety Features, Maintenance Cost, and Price Point attributes of the four vehicle models that the company criteria respectively weights by 10, 5, and 7 is provided."]}
			]
		},
		{
		...
		},
		{
			...
			"grades": [
				{"name":"Competent","text":["The submission presents [STATE THE THREE FORMATS, e.g. a horizontal and a vertical bar chart and a heat map] to effectively support the comparison of the vehicle models against the elements of the company criteria."]}
			]
		},
		{
			"name":"G. Visual Presentation: Criteria 2", 
			"grades": [
				{"name":"Competent","text":["The submission presents [STATE THE THREE FORMATS, e.g. a horizontal and a vertical bar chart and a heat map] to effectively support the comparison of the vehicle models against the elements of the personal criteria."]}
			]
		},
		{
			"name":"H. Dashboard", 
		...
		},
		{
			...
			"grades": [
				{"name":"Competent","text":["The work clearly recommends the purchase a [VEHICLE] for the company justified by the sum of weighted values for the elements of the combined criterion."]}
			]
		},
		{
			"name":"J. Storytelling Methods", 
			"grades": [
				{"name":"Approaching Competence","text":["The submission clealy notes the [VEHICLE] scores best on almost all of the six aspects. The explanation for how storytelling methods were used to effectively support the presentation of the recommendation is presented with limited detail. Please update the explanation of the applied storytelling methods once revised visualization elements are in place."]}
			]
		},
		{
			"name":"K. Web Sources", 
		...
		},
		{
			...
			"grades": [
				...
				{"name":"Passing","text":["The submission effectively scrapes data from the [WEBSITE] and uses the company and a personal criterion to support the justification of the recommendation to purchase a 2017 Honda CR-V for the organization. Clear visualizations provide adequate support to the comparison of the vehicles against the elements of the combined criteria. All sections of the work, including Storytelling Methods, are complete and meet standards."]}
			]
		}
	]
};
...
var crdCIMTask1 = 
{
	...
	"aspects": [
		...
		},
		{
			"name":"B: Fact Sheet", 
			"grades": [
				{"name":"Not Evident","text":["The submission outlines the product, the rationale for implementation, and the plan for implementing Google Chrome for the manufacturing company. A graphical element or elements that support the description of the technology solution or the explanation of the implementation plan cannot be located."]},
		...
		},
		{
			...
			"grades": [
				{"name":"Approaching Competence","text":["The submission explains how the knowledge of the audiences informed the composition of the two artifacts. An adequately detailed description of each of the given attribute of the two audiences is not readily evident."]},
...
var crdCIMTask2 = 
{
	...
	"aspects": [
		...
		},
		{
			...
			"grades": [
				{"name":"Approaching/Not Evident","text":["The submission outlines three outside works. The learnings from the third-party artifacts are presented in limited detail and it is unclear how the case study review informs the proposed project."]},
				{"name":"Competent","text":["A reasonable case study review that summarize the implementation of key elements of the proposal for [COMPANY 1], [COMPANY 2], and [COMPANY 3] are provided."]}
			]
		},
		{
			"name":"D3. Goals , Objectives, and Deliverables", 
			"grades": [
				{"name":"Approaching/Not Evident","text":["The submission provides a list of goals and supporting objectives with notes of the methods that will be used to meet those objectives. The project deliverables are unclear, and the goal and the objectives are presented in limited detail. A detailed description of the project goal, objectives, and key deliverables is needed to meet standards."]},
		...
		},
		{
			...
			"grades": [
				{"name":"Approaching/Not Evident","text":["The work provides a timeline. An appropriate timeline that provides completion dates for each deliverable is not observed."]},
		...
		},
		{
			"name":"D6. Outcome", 
			"grades": [
				{"name":"Approaching/Not Evident","text":["The submission discusses the anticipated project outcomes. A description of the criteria that will be used to assess the success of the project is not observed."]},
	...
	"aspects": [
		{
			...
			"grades": [			
				{"name":"Approaching","text":["A reduced dataset of 1,046 events is provided in the submission. The dataset includes an observation that is missing information about District/Sector. A cleaned dataset with appropriate handling of all missing or unnecessary data is needed to meet requirements."]},
				{"name":"Competent","text":["A dataset that provides attributes of [Number of events] that adequately support the distribution analysis of the incidents captured from the 911 calls to the Seattle Police Department is provided."]}
			]
		},
		{
			"name":"B: Data Preparation Explanation",
			"grades": [			
				{"name":"Approaching","text":["The submission explains why a reduction in dimensionality was performed on the provided dataset. An explanation of how the missing sector data is handled is not observed."]},
		...
		},
		{
			"name":"G: Residuals",
			"grades": [			
				{"name":"Approaching","text":["A reasonable recommendation to remove the outliers from consideration to improve the fit of the linear regression model is presented. A residual plot that shows the residuals on the vertical axis and the independent variable on the horizontal axis, cannot be located."]},
		...
		},
		{
			...
			"grades": [			
				{"name":"Approaching","text":["Outlines of general behaviors to be exercised when working with sensitive data are presented. The specific precautions the Seattle Police Department is to exercise when working with the given sensitive data are unclear."]},
		...
		},
		{
			...
			"grades": [
				...
				{"name":"Not Passing","text":["The submission presents sound analyses of the distribution of 1,046 events captured from the 911 calls to the Seattle Police Department by date, type, and sector; the given linear regression model and the behavior of its outliers and residuals; and the eligibility of the precinct for additional state funding. Adequate descriptions of the specific precautions the department is to exercise when working with and communicating about its sensitive data are not observed. A revision of the response to the task prompt Precautions or Behaviors is needed to meet standards. "]}
			]
		}
	]
};
...
var crdIXPTask1 = 
{
	...
	"aspects": [
		...
		},
		{
			...
			"grades": [	
				{"name":"Not Evident","text":["The submission applies and annotates [Logistic Regression] to explain customer churn. The application and interpretation of an appropriate descriptive method cannot be located."]}, 
	...
	"aspects": [
		{
			"name":"A: Problem",
			"grades": [
				{"name":"Competent","text":["Environmental modifications, such as [OBSTACLE 1] and [OBSTACLE 2] that simulate the aftermath of [DISASTER ENVIRONMENT], are succinctly outlined."]}
			]
		},
		{
			"name":"B: Improved Disaster Recovery",
			"grades": [
				{"name":"Competent","text":["A detailed explanation of the robot's functional support in the modified environment, such as [HOW], is evident."]}
			]
		},
		{
			"name":"C: Architecture",
		...
		},
		{
			"name":"D: Goal Seeking",
			"grades": [
				{"name":"Competent","text":["The submission adequately explains how the implemented optimization principles impact the prototype’s reasoning, knowledge, representation, uncertainty, and intelligence, such as using sensor input to [EXAMPLE OF: reasoning, knowledge, representation, uncertainty, or intelligence]."]}
			]
		},
		{
		...
		},
		{
			...
			"grades": [
				{"name":"Competent","text":["Adequate justification for test cases, reasonable scenarios, and a description of the acceptance criterion for each is provided in the submission."]}
			]
		},
		{
			"name":"G: Improving the Prototype",
			"grades": [
				{"name":"Competent","text":["Reasonable summaries of further optimization efforts using Reinforced Learning, such as [SUMMARIES, e.g. application of reinforced learning, how the robot can learn what areas are safe terrain, and how the learnings are used to improve the robot’s abilities] are provided."]}
			]
		},
		{
			"name":"H: Code",
...
var crdNIPTask1 = 
{
	...
	"aspects": [
		...
		},
		{
			"name":"D: Training",
			"grades": [
				{"name":"Competent","text":["The submission adequately discusses the training cases used to find additional patterns for the chatbot to recognize.","The submission adequately describes how the chatbot’s AIML rules-based decision tree architecture uses [AIML TAGS OR JOB TRAINING WEBSITES] that determine the most appropriate response to user inputs."]}
			]
		},
		{
			"name":"E: Optimization",
			"grades": [
				{"name":"Competent","text":["An adequate explanation of the optimization process for the chatbot is provided.","The submission adequately explains how the [AIML TAGS] tags were used to optimize the AIML script."]}
			]
		},
		{
		...
		},
		{
			...
			"grades": [
				{"name":"Competent","text":["A succinct analysis of the strengths and weaknesses of the development environment are presented.","The submission identifies [ONE EXAMPLE] as a strength, and [ONE EXAMPLE] as the weakness of the given environment."]}
			]
		},
		{
		...
		},
		{
			"name":"Overall Comment",
			"grades": [
				{"name":"Passing","text":["The submission presents a finalized report about an advisory chatbot developed with a [rules-based decision tree architecture OR OTHER METHOD] that handles Computer Science students’ career-based questions, an instructive installation manual, and a [HOW LONG]-minute Panopto screen capture featuring a narrated interactive session with the chatbot. The work provides detailed summaries of the use of the AIML tags used to train and optimize the chatbot’s interactions with the user, a reasonable evaluation framework, and thoughtful discussions of the challenges faced during the development phases. All sections of the work, including Optimization, are complete and meet standards."]}
			]
		}
	]
};
	...
	"aspects": [
		{
			...
			"grades": [			
				{"name":"Competent","text":["The [SELECTED ALGORITHM] is logically identified and can perform the task to meet all requirements."]}
			]
		},
		{
			"name":"B1: Logic Comments",
			"grades": [	
				{"name":"Approaching/Not Evident","text":["A brief description of [?] is provided in the submission. An overview using pseudocode with comments to explain the algorithm is not readily evident. Please provide an overview similar to the example in the Sample Core Algorithm Overview.docx file that is located in the Supporting Documents section of the task instructions."]},
				{"name":"Competent","text":["The submission provides pseudocode and comments that accurately explain the logic applied to the solution."]}
			]
		},
		{
		...
		},
		{
			...
			"grades": [			
				{"name":"Competent","text":["The work clearly states the overall time complexity is [ALGORITHM COMPEXITY] and provides space-time complexity analysis for all blocks of code."]}
			]
		},
		{
			"name":"B4: Adaptability",
			"grades": [			
				{"name":"Competent","text":["The work concisely describes that the number of packages on a truck is a key limitation, but, that the algorithm can scale within that limitation."]}
			]
		},
		{
			"name":"B5: Software Efficiency and Maintainability",
			"grades": [			
				{"name":"Competent","text":["An adequate description of the object-oriented approach is provided to support the stated assertion that the software is efficient and maintainable."]}
			]
		},
		{
			"name":"B6: Self-Adjusting Data Structures",
			"grades": [			
				{"name":"Competent","text":["An adequate description of the [DATA STRUCT TYPE] data structure used is provided in the submission."]}
			]
		},
		{
			"name":"C: Original Code",
			"grades": [			
				{"name":"Competent","text":["Original code is provided that clearly shows all packages are delivered on time with [NUM MILES] miles on all trucks."]}
			]
		},
		{
			"name":"C1: Identification Information",
			"grades": [			
				{"name":"Approaching","text":["The initial comment is appropriately provided on the first line of the file [FILE NAME]. The initial comment is not observed in the remaining Python files."]},
				{"name":"Competent","text":["The submission appropriately includes the initial code comment on the first line of all files."]}
			]
		},
		{
			"name":"C2: Process and Flow Comments",
			"grades": [			
				{"name":"Competent","text":["Appropriate process and flow comments are provided to explain the role and actions of each block of code within the program."]}
			]
		},
		{
		...
		},
		{
			...
			"grades": [			
				{"name":"Competent","text":["An adequate description of the [DATA STRUCT TYPE] data structure is provided in the submission."]}
			]
		},
		{
			"name":"E: Hash Table",
			"grades": [			
				{"name":"Competent","text":["A hash table with an insertion function is clearly present in the [CODE FILE NAME] file."]}
			]
		},
		{
			"name":"F: Look-Up Function",
			"grades": [			
				{"name":"Competent","text":["A look-up function named lookup_package that aligns with the given data elements and returns correct data is appropriately provided."]}
			]
		},
		{
			"name":"G: Interface",
			"grades": [			
				{"name":"Not Evident","text":["A program that clearly runs to completion without errors is provided. An interface to allow a user to input data to view the status of any package at any time is not readily evident."]}
			]
		},
		{
			"name":"G1: First Status Check",
			"grades": [			
				{"name":"Not Evident","text":["[WHAT] is clearly provided in the submission. A screenshot for the First Status Check is not readily evident."]},
				{"name":"Competent","text":["A screenshot that clearly shows the status of all packages on each truck at [TIME] is provided in the submission."]}
			]
		},
		{
			"name":"G2: Second Status Check",
			"grades": [	
				{"name":"Not Evident","text":["[WHAT] is clearly provided in the submission. A screenshot for the Second Status Check is not readily evident."]},
				{"name":"Competent","text":["A screenshot that clearly shows the status of all packages on each truck at [TIME] is provided in the submission."]}
			]
		},
		{
			...
			"grades": [			
				{"name":"Not Evident","text":["[WHAT] is clearly provided in the submission. A screenshot for the Third Status Check is not readily evident."]},
				{"name":"Competent","text":[" A screenshot that clearly shows the status of all packages on each truck at [TIME] is provided in the submission."]}
			]
		},
		{
			...
			"grades": [		
				{"name":"Not Evident","text":["[WHAT] is clearly provided in the submission. A screenshot to capture a complete execution of the code is not readily evident."]},
				{"name":"Competent","text":["A screenshot that clearly captures a complete execution of the code is provided in the submission."]}
			]
		},
		{
			"name":"I1: Strengths of the Chosen Algorithm",
			"grades": [			
				{"name":"Competent","text":["Reasonable space-time complexity and incremental processing are logically described as the key advantages of the algorithm."]}
			]
		},
		{
			"name":"I2: Verification of Algorithm",
			"grades": [			
				{"name":"Competent","text":["The algorithm clearly shows all packages are delivered on time with [NUM MILES] miles on all trucks."]}
			]
		},
		{
			"name":"I3: Other Possible Algorithms",
			"grades": [			
				{"name":"Competent","text":["[ALGORITHM 1] and [ALGORITHM 2] are clearly identified as alternative algorithms."]}
			]
		},
		{
			"name":"I3a: Algorithm Differences",
			"grades": [			
				{"name":"Competent","text":["A discussion that juxtaposes [ALGORITHM 1] and [ALGORITHM 2] with the [SELECTED ALGORITHM] algorithm is provided in the submission."]}
			]
		},
		{
			"name":"J: Different Approach",
			"grades": [			
				{"name":"Competent","text":["The work logically describes the alternative approach of [DIFFERENT APPROACH]."]}
			]
		},
		{
			"name":"K1: Verification of Data Structure",
			"grades": [			
				{"name":"Competent","text":["The algorithm clearly shows the total miles on all trucks to be [NUM MILES], all packages are delivered on time, and the hash table look-up function is present."]}
			]
		},
		{
			"name":"K1a: Efficiency",
			"grades": [			
				{"name":"Approaching","text":["The work clearly describes the space-time complexity of the data structure. A description of the efficiency that includes what type of data is being used and how that data is being used is not observed."]},
				{"name":"Competent","text":["The description of the speed of the [DATA STRUCT] and the ability to minimize collisions suitably supports the data structure efficiency."]}
			]
		},
		{
			"name":"K1b: Overhead",
			"grades": [		
				{"name":"Approaching","text":["A description of how hashing by address impacts space complexity is provided. An explanation that addresses the computational time and bandwidth overhead when handling data is not readily evident."]},
				{"name":"Competent","text":["The low processing time, minimal memory use, and minimal bandwidth use with the chosen approach are suitably explained."]}
			]
		},
		{
			"name":"K1c: Implications",
			"grades": [		
				{"name":"Approaching","text":["The work briefly notes that the size of the data structure will increase with more packages. A description that addresses the implications of increasing packages, trucks, and cities, including the idea of control when different or numerous sub-applications or subsystems are incorporated in the expansion, is not readily evident."]},
				{"name":"Competent","text":["Implications of scaling the application for increased packages, trucks, and cities are concisely described in the [ALGORITHM] analysis."]}
			]
		},
		{
